...
class Breadcrumbs(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs), View.OnClickListener {
    ...
    fun setBreadcrumb(fullPath: String, currCatId: Long) {
        lastPath = fullPath
        lastCatId = currCatId
        ...
        for (i in dirs.indices) {
            ...
            val item = FileDirItem(currPath, dir, true, 0, currCatId)
    ...
    fun updateColor(color: Int) {
        textColor = color
        setBreadcrumb(lastPath, lastCatId)
    }
