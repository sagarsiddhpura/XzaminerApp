...
class ManageCourseSectionDomainVideosAdapter(
    activity: ManageCourseSectionVideosDomainActivity, var videos: ArrayList<Video>, recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit) :
        MyRecyclerViewAdapter(activity, recyclerView, null, itemClick) {

    private var courseSectionVideosDomainActivity: ManageCourseSectionVideosDomainActivity
    ...
    private fun setupView(view: View, video: Video) {
        view.apply {
            ...
            manage_edit.setOnClickListener {
                courseSectionVideosDomainActivity?.editVideo(video)
            }
