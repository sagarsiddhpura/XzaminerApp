...
class DebugDataSource {
    ...
    private fun getCourses(id: Int): HashMap<String, Course>? {
        if (id == 1) {
            val c1 = Course(
                ...
                "images/cat_2.png",
                getConcepts(101), getQuestionBanks(101), getReviewManuals(101), getFlashCards(101)
            )
    ...
    private fun getQuestions(i: Int): ArrayList<Question> {
        if(i == 1013) {
            return  arrayListOf(
                Question(1, "For compliance testing which sampling method is more useful ?", "",
                    arrayListOf(QuestionOption(1, "Attribute Sampling", "")),
                    2),
                Question(2, "First step of Risk Assessement is to?", "",
                    arrayListOf(QuestionOption(1, "Identify Assets", "")),
                    2),
                Question(3, "Risk that a misstatement could occur but may not be detected and corrected or prevented by entity’s internal control mechanism is called", "",
                    arrayListOf(QuestionOption(1, "Control Risk", "")),
                    2),
                Question(4, "In any given scenario, compliance testing checks for the presence of controls whereas substantive testing checks the integrity of contents i.e. test of individual transactions. True or False", "",
                    arrayListOf(QuestionOption(1, "TRUE", "")),
                    2),
                Question(5, "Purpose of CSA (Control Self Assessement)", "",
                    arrayListOf(QuestionOption(1, "enhance audit responsibilities", "")),
                    2))
        }
        if(i == 1011) {
            return  arrayListOf(
                Question(1, "About Risk Assessement?", "",
                    arrayListOf(QuestionOption(1, "Step 01 - Identify Assets", ""),
                        QuestionOption(2, "Step 02 - Identify Vulnerability / Threats", ""),
                        QuestionOption(3, "Step 03 - Impact Analysis", ""),
                        QuestionOption(4, "Step 04 - Prioritize on the basis of Impact", ""),
                        QuestionOption(5, "Step 05 - Evaluate Controls", ""),
                        QuestionOption(6, "Step 06 - Apply Appropriate Controls", "")),
                    2),
                Question(2, "Types of Risks?", "",
                    arrayListOf(QuestionOption(1, "Inherent Risks - ", ""),
                    ...
                    2),
                Question(3, "Compliance & Substantive Testing?", "",
                    arrayListOf(QuestionOption(1, "compliance testing test controls, while substantive testing tests details", ""),
                        QuestionOption(2, "compliance testing checks for the presence of controls whereas substantive testing checks the integrity of contents", ""),
                        QuestionOption(3, "In any given scenario, outcome/result of compliance testing will form the basis for planning of substantive testing.  ", ""),
                        QuestionOption(4, "attribute sampling method (either control is present or absent) will be useful when testing for compliance.", "")),
                    2))
        }
        if(i == 1012) {
            return  arrayListOf(
                Question(1, "Information System Management", "",
                    arrayListOf(QuestionOption(1, "Information security management is the collection of policies, processes, and procedures that ensure an organization’s security policy is effective. Security management is composed of a number of distinct and interrelated processes, including policy development and enforcement, security awareness training, user access management, security incident management, vulnerability management, service provider management, encryption, network access management, environmental controls, and physical access controls. Ongoing executive support is key to the success of a security management program.", ""),
                    ...
                    2),
                Question(2, "Policies & Procedures", "",
                    arrayListOf(QuestionOption(1, "Statement of executive support: The policy document must clearly state that the information security policy has the full and unwavering support of the organization’s executives. The policy should include a signature block that shows their support in writing. ", ""),
                        QuestionOption(2, "Roles and responsibilities: Information security policy should define security-related roles and responsibilities, including who is responsible for policy development and enforcement. It should also include who is responsible for performing risk assessments and making risk-based decisions. The policy should also describe how the structure of asset ownership works and clearly state how asset owners have some responsibilities in protecting the assets that they control. Finally, the policy should state the responsibilities that all employees have. ", ""),
                        QuestionOption(3, "Value of information-related assets: The information security policy should include the idea that the organization’s information system and information are valued assets that deserve protection. While the tangibility of some assets may be difficult to value monetarily, they are valuable nonetheless and must be protected. ", ""),
                        QuestionOption(4, "Protection of information assets: Since the organization’s informationrelated assets have value, they must be protected. The policy should describe the ways that information assets are protected through controls to protect their confidentiality, integrity, and availability. ", "")),
                    2))
        }
        if(i == 1) {
            return  arrayListOf(
